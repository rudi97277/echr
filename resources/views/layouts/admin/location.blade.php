...
{{-- @section('title')
    <h1 class="font-semibold text-lg">Data Lokasi</h1>
@endsection --}}
@section('content')
    <div class="w-full h-full overflow-y-scroll">
        <x-custom-table :$headers :source="$locations" :$pagination>
            @scopedslot('action', $item)
                <div class="flex gap-1">
                    <a class="rounded-md bg-main text-white p-1 flex items-center"
                        href="{{ route('admin.master-lokasi.edit', AppHelper::obfuscate($item->id)) }}">
