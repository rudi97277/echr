{{-- md:w-2/4 lg:w-1/3 --}}
<div class="flex w-full max-w-[400px] mx-auto p-4 flex-col sm:flex-row items-center pb-[70px]">
    <div class="w-full flex flex-col gap-4">
        <div class="flex p-4 w-full flex-col justify-center items-center bg-white shadow-md rounded-md gap-4 text-dark">
            ...
            <button type="button"
                {{ $lat == 0 || $long == 0 || ($attendance?->clock_in != null && $attendance?->clock_out != null) ? 'disabled' : '' }}
                ...
                {{ $lat == 0 && $long == 0 ? 'Mendapatkan Lokasi' : ($attendance?->clock_in == null ? 'Absensi Masuk' : 'Absensi Keluar') }}
            </button>
        </div>
